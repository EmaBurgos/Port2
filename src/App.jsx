          ...
          <div className="container-info">
            <div className="info">
              ...
              <p>
                ...
                atractivas y funcionales que brinden una experiencia excepcional
                a los usuarios. Con una sólida experiencia en desarrollo web con{" "}
                <span className="span-color">+800</span> horas de estudio y una
                amplia gama de habilidades técnicas, estoy listo para asumir
                nuevos desafíos y contribuir al éxito de cualquier proyecto. Soy
                una persona autodidacta y busco ayudar al mundo con mis
                conocimientos.
              </p>
              ...
              <p>
                ¡Te doy una amable bienvenida a mi portfolio y estaría encantado
                de ayudarte! No dudes en contactarme. 💙
              </p>
            </div>
        ...
        <section className="container-dad-tech" id="Tecnologias">
          <div className="container-tech">
            ...
            <div className="tech-image">
              <div>
                <h2 className="title-tech">Frontend</h2>
              ...
              <div>
                <h2 className="title-tech">Backend</h2>
                <div className="tecnos">
          ...
          <div className="cards">
            ...
            <article className="card">
              ...
              <div className="titles-cards">
                <h3>Rick y Morty</h3>
                <p>
                  Utiliza la Api de Rick y Morty, Se pueden organizar y filtrar
                  los personajes de la Mitica serie de Rick y Morty
                </p>
                <a
                  className="btn"
            ...
            <article className="card">
              ...
              <div className="titles-cards">
                ...
                <p>
                  Cotiza el precio de los seguros $, Aplicacion Web creada en mi
                  tiempo libre con React
                </p>
                <a
                  className="btn"
            ...
            <article className="card">
              ...
              <div className="titles-cards">
                <h3>Calculadora</h3>
                <p>
                  Calculadora con Javascript Puro, Uno de mis primeros proyectos
                  realizados en mi tiempo libre de forma autodidacta
                </p>
                <a
                  className="btn"
          ...
          <div className="cards">
            <article className="card">
              ...
              <div className="titles-cards">
                ...
                <p>
                  Bootcamp Intensivo, Javascript, HTML, CSS, React, Node, Redux,
                  SQL, +800 horas
                </p>
              </div>
            </article>
              ...
              <div className="Comida">
                ...
                <div className="boton-div">
                  ...
                  <input
                    type="hidden"
                    name="_next"
                    value="https://emaburgos.vercel.app/"
                  />
